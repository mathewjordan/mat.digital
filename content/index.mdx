<Section size="1">
  <Box mb="6">
    <Text size="5" weight="light">
      <Balancer><Em>Creating digital experiences that are simple and human</Em>.</Balancer>
    </Text>
  </Box>

I am designer and developer from Asheville, North Carolina,
United States, and work for Northwestern University where I contribute to open-source software that enhance digital
collections and scholarship. When not ruminating in the office, I am likely to be found
